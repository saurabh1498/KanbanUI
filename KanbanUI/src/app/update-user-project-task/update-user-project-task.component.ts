...
@Component({
  selector: 'app-update-user-project-task',
  templateUrl: './update-user-project-task.component.html',
  styleUrls: ['./update-user-project-task.component.css']
})
export class UpdateUserProjectTaskComponent implements OnInit {
